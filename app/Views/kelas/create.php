      ...
      <div class="page-breadcrumb">
        <div class="row align-items-center">
          <div class="col-12">
            ...
            <h1 class="mb-0 fw-bold text-center"> Form Tambah Data Kelas </h1>
          </div>
        </div>
      </div>
              ...
              <div class="card-body">
                <form action="<?= base_url('kelas/store'); ?>" method="post">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-lg" type="text" id="kelas" name="kelas" placeholder="Masukan Nama Kelas" />
                  </div><br>
                  <div class="form-group">
                    <label class="form-label" for="description">Deskripsi</label>
                    <input class="form-control form-control-lg" type="text" id="description" name="description" placeholder="Masukan Description" />
                  </div><br>

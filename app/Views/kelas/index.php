      ...
      <div class="page-breadcrumb">
        <div class="row align-items-center">
          <div class="col-12">
            ...
            <h1 class="mb-0 fw-bold text-center"> Informasi Data Kelas </h1>
          </div>
        </div>
        <a href="<?php echo base_url('/kelas/create'); ?>" class="link" style="float: right;">
                    ...
                    <tbody>
                      <?php foreach ($kelas as $key => $row) { ?>
                        <tr>
                          ...
                          <td scope="col" class="text-center"><?php echo $row['description']; ?></td>

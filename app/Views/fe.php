    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Pembayaran SPP Kini Lebih Mudah</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Dengan website pembayaran SPP untuk Orang Tua Siswa</h2>
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>SPP Digital</h2>
          <p>Keuntungan Pembayaran SPP Secara  Digital</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              ...
              <h3>Tidak Perlu Datang Kesekolah</h3>
              <p>Dengan sistem ini anda tidak perlu datang kesekolah, cukup bayar dan informasikan ke kami</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h3>Pembayaran Bisa  Dimana Saja</h3>
              <p>Tidak perlu lagi harus membawa buku pembayaran, anda bisa membayar spp dimana saja!.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
            <div class="box">
              ...
              <h3>Hemat Waktu</h3>
              <p>Pembayaran secara digital akan menghemat waktu anda, karna anda hanya tinggal bayar dan <b>Selesai</b>.</p>
            </div>
          </div>

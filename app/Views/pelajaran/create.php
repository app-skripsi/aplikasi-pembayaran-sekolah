      ...
      <div class="page-breadcrumb">
        <div class="row align-items-center">
          <div class="col-12">
            ...
            <h1 class="mb-0 fw-bold text-center"> Form Tambah Data Pelajaran </h1>
          </div>
        </div>
      </div>
              ...
              <div class="card-body">
                <form action="<?= base_url('pelajaran/store'); ?>" method="post">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-lg" type="text" id="nama_pelajaran" name="nama_pelajaran" placeholder="Masukan Pelajaran" />
                  </div><br>
